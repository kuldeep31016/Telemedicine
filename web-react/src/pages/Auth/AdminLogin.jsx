      ...
      >
        <div className="text-center mb-8">
          <motion.div
            ...
            className="w-20 h-20 mx-auto mb-4 bg-gradient-to-r from-green-600 to-teal-600 rounded-2xl flex items-center justify-center shadow-lg"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <Input
            ...
            error={errors.email}
            placeholder="admin@gramsehat.com"
        ...
        <div className="mt-8 text-center space-y-3">
          ...
          <p className="text-gray-600">
            Not registered yet?{' '}
            <Link to="/register?role=admin" className="text-green-600 hover:text-green-700 font-semibold">
              Register as Admin
            </Link>
          </p>
        </div>
