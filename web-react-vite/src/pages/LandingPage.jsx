          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            >
              ...
              <div className="space-y-6">
                {[
                  { icon: Phone, label: 'Phone', value: '+91 9508874235', sub: 'Mon–Sun, 24/7 support' },
                  { icon: Mail, label: 'Email', value: 'soonlay.tech@gmail.com', sub: 'We reply within 2 hours' },
                  { icon: MapPin, label: 'Office', value: 'Telemedicine', sub: 'Kumarswamy Layout, Bengaluru, 560078' },
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-10 pb-8 border-b border-white/20">
            ...
            <div className="col-span-2">
              <div className="flex items-center gap-2.5 mb-3">
                ...
                <span className="text-xl font-bold text-white tracking-tight">Telemedicine</span>
              </div>
              <p className="text-white/60 text-sm leading-relaxed mb-5">
                Connecting patients with certified doctors anytime, anywhere, through secure and reliable digital healthcare.
              </p>
              <div className="flex items-center gap-3">
                {/* LinkedIn */}
                <button className="w-9 h-9 rounded-lg bg-white/10 hover:bg-white/20 transition-colors flex items-center justify-center">
                  <svg className="w-4 h-4 fill-white/70" viewBox="0 0 24 24"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2zm2-6a2 2 0 1 1 0 4 2 2 0 0 1 0-4z"/></svg>
                </button>
                {/* Instagram */}
                <button className="w-9 h-9 rounded-lg bg-white/10 hover:bg-white/20 transition-colors flex items-center justify-center">
                ...
                {/* X / Twitter */}
                <button className="w-9 h-9 rounded-lg bg-white/10 hover:bg-white/20 transition-colors flex items-center justify-center">
                  <svg className="w-4 h-4 fill-white/70" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </button>
              </div>
            </div>
            ...
            {/* Col 3 — Services */}
            <div>
              <h4 className="text-white font-bold mb-3 text-[15px]">Services</h4>
              <ul className="space-y-1">
                {['Video Consultation', 'Health Monitoring', 'Digital Prescriptions', 'Mental Health Care'].map(item => (
                  <li key={item}>
                    <button
            ...
            {/* Col 4 — For Patients */}
            <div>
              <h4 className="text-white font-bold mb-3 text-[15px]">For Patients</h4>
              <ul className="space-y-1">
                {[
            ...
            <div>
              ...
              <ul className="space-y-1">
                <li className="text-white/60 text-sm">soonlay.tech@gmail.com</li>
        ...
        <form onSubmit={handleAdminSubmit} className="space-y-6">
          ...
          <div className="text-center pt-2 space-y-2">
            ...
            <p className="text-sm text-gray-500">
              Need help? Contact <a href="#" className="text-[#6C5DD3] font-semibold">soonlay.tech@gmail.com</a>
            </p>
          </div>
        </form>
      </Modal>
